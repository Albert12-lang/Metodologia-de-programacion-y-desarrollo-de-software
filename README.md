...
## Sentencias con ciclos (for).
1. Tabla de multiplicar (Alavera Mejía Wellington Zinedine).
...
9. Operaciones matemática entre enteros(Landivar López Francisco Alberto).
10. Números Perfectos(Landivar López Francisco Alberto).
...
El objetivo de esta tarea es que el estudiante investigue y aplique el uso sobre estructuras
repetitivas usando los bucles Para (FOR).
